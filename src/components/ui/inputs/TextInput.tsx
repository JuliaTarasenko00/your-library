      ...
      <div className="relative w-full">
        <div className="relative">
          ...
          <input
            ...
            {...rest}
            ref={_ref}
            className={`w-full rounded-[12px] border-[1px] bg-[#262626] py-[16px] pl-[${labelWidth}px] pr-[14px] text-[12px] text-[#F9F9F9] md:text-[14px] ${errorMessage ? 'border-[#E90516]' : 'border-transparent hover:border-[#F9F9F91A] focus:border-[#F9F9F91A]'} outline-none transition duration-300`}
          />
        </div>
